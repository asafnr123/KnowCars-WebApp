    ...
    return (
        <section className="background-about">
            <div className="about-content-box">
                ...
                <p>We are here to help you choose you'r favorite car</p>

                <p>Welcome to KnowCars, your go-to source for discovering and understanding cars like never before. 
                Whether you're a car enthusiast, a future buyer, or just curious, our platform gives you quick and clear
